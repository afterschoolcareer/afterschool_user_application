...
class ShortlistCard extends StatefulWidget {
  ...
  final int id;
  const ShortlistCard({Key? key, required this.logo, required this.name,
    required this.location, required this.id}) : super(key: key);

  @override
  State<ShortlistCard> createState() => _ShortlistCard();
}

class _ShortlistCard extends State<ShortlistCard> {
